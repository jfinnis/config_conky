...
echo '${goto 435}''${font mono:Bold:size=10}'$TOPLINE | sed 's/Su/${color0}Su${color1}/g' | sed 's/Sa/${color0}Sa${color1}/g'
echo '${goto 435}''${font mono:bold:size=10}''${color0}'$OVER '${color2}'$TODAY'${color1}'$REST
